  ...
  {/* curved corner bottom*/}
            ...
            <div className="flex items-end">
              ...
              style={{
                ...
                height: "148px",
                borderRadius:
                  "0 24px 0 24px" /* only top-right corner rounded to match screenshot */,
              }}
            >
              <div>
          ...
          <div className="flex flex-col gap-4  flex-1">
            ...
            <div className="relative ">
              ...
              <div className="bg-gray-100 relative p-6 rounded-4xl  text-gray-500 text-[15px] leading-relaxed">
                <div
